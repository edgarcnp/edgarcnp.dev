...
pub fn SkeletonBlock(class: String) -> Element {
    rsx! {
        div {
            class: "motion-safe:animate-pulse rounded-sm bg-zinc-800/70 {class}",
            aria_hidden: "true",
        }
    }
}
            ...
            for line in 0..lines {
                div {
                    class: if line + 1 == lines {
                        "h-3 w-2/3 rounded-sm bg-zinc-800/70 motion-safe:animate-pulse"
                    } else {
                        "h-3 w-full rounded-sm bg-zinc-800/70 motion-safe:animate-pulse"
                    }
                }
            }
        }
