...
updated: "2026-06-15"
status: "In Progress"
technologies: ["Astro", "SolidJS", "Cloudflare"]
featured: true
pinned: true
links:
  - label: "Live site"
...
This project establishes the portfolio foundation: an Astro site with SolidJS islands, typed local content, safe Markdown rendering, static contact links, and a dark responsive interface.
