...
The goal is to harden the portfolio without mixing deployment-specific code into UI or content modules. The UI should remain a clear Dioxus surface, while Worker-specific behavior stays at the edge boundary where response policy belongs.
